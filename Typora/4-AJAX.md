...
1. 需求：使用提前准备好的提示框，来把登录成功/失败结果提示给用户
   ...
   ![image-20230404105003019](./Typora-image/image-20230404105003019.png)
...
1. 打开备课代码运行图书管理案例效果-介绍要完成的增删改查业务效果和 Bootstrap 弹框使用
   ...
   ![image-20230404105414757](./Typora-image/image-20230404105414757.png)

   ![image-20230404105421707](./Typora-image/image-20230404105421707.png)
...
1. 什么是 Bootstrap 弹框？
   ...
   * 不离开当前页面，显示单独内容，供用户操作
     ...
     ![image-20230404105801739](./Typora-image/image-20230404105801739.png)

2. 需求：使用 Bootstrap 弹框，先做个简单效果，点击按钮，让弹框出现，点击 X 和 Close 让弹框隐藏

   ![image-20230404105858660](./Typora-image/image-20230404105858660.png)
...
1. 为什么需要 JS 方式控制呢？
   ...
   * 例如：
     ...
     * 点击保存按钮，在弹框隐藏之前，获取用户填入的名字并打印
     ...
     ![image-20230404110038828](./Typora-image/image-20230404110038828.png)
...
1. 需求：基于 axios 获取到图书列表数据，并用 JS 代码渲染数据，到准备好的模板标签中
   ...
   ![image-20230404110943200](./Typora-image/image-20230404110943200.png)
...
2. 步骤：
   ...
   2. 渲染数据
      ...
      ![image-20230404110953752](./Typora-image/image-20230404110953752.png)

      ![image-20230404111014560](./Typora-image/image-20230404111014560.png)
...
1. 需求：点击添加按钮，出现准备好的新增图书弹框，填写图书信息提交到服务器保存，并更新图书列表
   ...
   ![image-20230404111235862](./Typora-image/image-20230404111235862.png)

   ![image-20230404111251254](./Typora-image/image-20230404111251254.png)
...
2. 步骤：
   ...
   3. 刷新-图书列表）（重新调用下之前封装的获取并渲染列表的函数）
      ...
      ![image-20230404111343653](./Typora-image/image-20230404111343653.png)
...
1. 需求：点击图书删除元素，删除当前图书数据
   ...
   ![image-20230404111530311](./Typora-image/image-20230404111530311.png)

   ![image-20230404111546639](./Typora-image/image-20230404111546639.png)
...
2. 步骤：
   ...
   3. 重新获取并刷新图书列表
      ...
      ![image-20230404111612125](./Typora-image/image-20230404111612125.png)
...
2. 需求：完成编辑图书回显当前图书数据到编辑表单，在用户点击修改按钮，收集数据提交到服务器保存，并刷新列表
   ...
   ![image-20230404111722254](./Typora-image/image-20230404111722254.png)
...
3. 编辑数据的核心思路：
   ...
   2. 基于 axios 和接口文档，调用查询图书详情接口，获取正在编辑的图书数据，并回显到表单中（页面上的数据是在用户的浏览器中不够准备，所以只要是查看数据都要从服务器获取）
      ...
      ![image-20230404111739153](./Typora-image/image-20230404111739153.png)

   3. 收集并提交保存修改数据，并重新从服务器获取列表刷新页面

      ![image-20230404111756655](./Typora-image/image-20230404111756655.png)
...
1. 因为增删改查的业务在前端实际开发中非常常见，思路是可以通用的，所以总结下思路
   ...
   ![image-20230404111941722](./Typora-image/image-20230404111941722.png)
...
3. 新增数据（增）
   ...
   ![image-20230404112942935](./Typora-image/image-20230404112942935.png)
...
4. 删除图书（删）
   ...
   ![image-20230404113338815](./Typora-image/image-20230404113338815.png)
...
5. 编辑图书（改）
   ...
   ![image-20230404113702515](./Typora-image/image-20230404113702515.png)
...
1. 需求：先运行备课代码，查看要完成的效果，点击右上角选择本机中提供的素材图片，更换网站背景图
   ...
   ![image-20230404122349505](./Typora-image/image-20230404122349505.png)
...
1. 需求：先运行备课代码，查看要完成的效果
   ...
   ![image-20230404123206073](./Typora-image/image-20230404123206073.png)
...
1. 需求：把外号对应的个人信息和头像，渲染到页面表单和头像标签上。
   ...
   ![image-20230404123708765](./Typora-image/image-20230404123708765.png)
...
1. 需求：点击修改用户头像
   ...
   ![image-20230404124524401](./Typora-image/image-20230404124524401.png)
...
2. 实现步骤如下：
   ...
   3. 提交到服务器保存此用户对应头像文件，并把返回的头像图片 url 网址设置在页面上
      ...
      ![image-20230404124540629](./Typora-image/image-20230404124540629.png)
...
1. 需求：点击提交按钮，收集个人信息，提交到服务器保存（无需重新获取刷新，因为页面已经是最新的数据了）
   ...
   2. 提交到服务器保存-调用用户信息更新接口（注意请求方法是 PUT）代表数据更新的意思
      ...
      ![image-20230404125310049](./Typora-image/image-20230404125310049.png)
...
1. 需求：使用 bootstrap 提示框，提示个人信息设置后的结果
   ...
   ![image-20230404125517679](./Typora-image/image-20230404125517679.png)
