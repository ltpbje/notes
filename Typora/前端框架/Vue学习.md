...
![image-20230801152120432](./image/202310022104470.png)
...
![image-20230801153622808](./image/202310022104471.png)
...
![image-20230801153739417](./image/202310022104473.png)

![image-20230801153814975](./image/202310022104474.png)
...
![image-20230801154255730](./image/202310022104475.png)
...
![image-20230802094928123](./image/202310022104476.png)

![image-20230802095012032](./image/202310022104477.png)
...
![image-20230802095318891](./image/202310022104478.png)



打开 Vue 运行的页面，调试工具中 Vue 栏，即可查看修改数据，进行调试。

![image-20230802095340194](./image/202310022104479.png)
...
![image-20230803100504246](./image/202310022104480.png)
...
![image-20230804101334871](./image/202310022104481.png)
...
![image-20230804221158469](./image/202310022104482.png)
...
![image-20230815222013297](./image/202310022104483.png)
...
为了方便开发者进行==样式控制==， Vue 扩展了 ==v-bind== 的语法，可以针对 ==class 类名== 和 ==style 行内样式== 进行控制 。![image-20230816120822686](./image/202310022104484.png)

### v-bind 对于样式控制的增强 - 操作class

语法` :class = "对象/数组"`

① `对象` → 键就是类名，值是布尔值。如果值为` true`，有这个类，否则没有这个类![image-20230816121130522](./image/202310022104485.png)

适用场景：一个类名，来回切换

② `数组 `→ 数组中所有的类，都会添加到盒子上，本质就是一个 `class 列表`![image-20230816121158955](./image/202310022104486.png)
...
![image-20230816212116064](./image/202310022104487.png)
...
适用场景：某个具体属性的动态设置![image-20230816212244456](./image/202310022104488.png)
...
![image-20230816220941045](./image/202310022104489.png)
...
![image-20230819095615304](./image/202310022104490.png)
...
![image-20230819220559323](./image/202310022104491.png)
...
![image-20230819220612492](./image/202310022104492.png)
...
![image-20230821220225721](./image/202310022104493.png)
...
![image-20230823193349053](./image/202310022104494.png)
...
![image-20230828142545290](./image/202310022104495.png)

==mounted== 模板渲染完成，可以开始==操作DOM==了

![image-20230828142557876](./image/202310022104496.png)

## 小黑记账清单

![image-20230828144959744](./image/202310022104497.png)
...
![image-20230828145019547](./image/202310022104498.png)
...
![image-20230828152933355](./image/202310022104499.png)
...
![image-20230829123750624](./image/202310022104500.png)
...
![image-20230903174056243](./image/202310022104501.png)

![image-20230903174307088](./image/202310022104503.png)
...
![image-20230903174512737](./image/202310022104504.png)
...
![image-20230903175519085](./image/202310022104505.png)
...
![image-20230903175842395](./image/202310022104506.png)
...
![image-20230903180702557](./image/202310022104507.png)
...
![image-20230903181656779](./image/202310022104508.png)
...
![image-20230910104918895](./image/202310022104509.png)
...
![image-20230910105456224](./image/202310022104510.png)
...
![image-20230910105635352](./image/202310022104511.png)
...
![image-20230910105935255](./image/202310022104512.png)

### 父 → 子

父组件通过 ==props== 将数据传递给子组件

![image-20230910110123343](./image/202310022104513.png)

### 子 → 父

子组件利用 ==$emit== 通知父组件，进行修改更新

![image-20230910110251358](./image/202310022104514.png)
...
![image-20230910110526594](./image/202310022104515.png)
...
![image-20230910111248238](./image/202310022104516.png)
...
![image-20230914203829826](./image/202310022104517.png)
...
![image-20230914204112490](./image/202310022104518.png)
...
![image-20230914205600185](./image/202310022104519.png)
...
==**原因：**Vue 是 异步更新 DOM (提升性能)==![image-20230923163303219](./image/202310022104520.png)
...
![image-20231001110921021](./image/202310022104521.png)
...
![image-20231002111952545](./image/202310022104522.png)
...
![image-20231002195410696](./image/202310022104523.png)
...
![image-20231002195540513](./image/202310022104524.png)
...
![1696248360666](./image/202310022104525.png)

Vue中路由：==路径== 和 ==组件== 的 ==映射== 关系

![image-20231002200753152](./image/202310022104526.png)
...
![image-20231002205451379](./image/202310022104527.png)
...
![image-20231002205904204](./image/202310022104528.png)
...
![image-20231013093738850](./image/202310152054201.png)
...
![image-20231013094042698](./image/202310152054203.png)
...
![image-20231014211407091](./image/202310152054204.png)
...
![image-20231014212120449](./image/202310152054206.png)
...
![image-20231014212627427](./image/202310152054207.png)
...
![image-20231015105455573](./image/202310152054208.png)
...
![image-20231015110827975](./image/202310152054209.png)
...
![image-20231015153834777](./image/202310152054210.png)
...
![image-20231015155205536](./image/202310152054211.png)
...
![image-20231015161330878](./image/202310152054212.png)
...
![image-20231015161522736](./image/202310152054213.png)
...
![image-20231015161617841](./image/202310152054214.png)
...
订单信息确认，可以共用同一个接口(参数不同)![image-20240112174554904](./image/image-20240112174554904.png)
...
![image-20240112175141031](./image/image-20240112175141031.png)
...
2. 买家留言绑定
3. 注册事件，调用方法提交订单并支付
![image-20240112175425747](./image/image-20240112175425747.png)

#### 订单管理 & 个人中心 (快速实现)

**目标：基于笔记，快速实现 订单管理 和 个人中心 跑通流程**

![image-20240112175456891](./image/image-20240112175456891.png)

![image-20240112175552514](./image/image-20240112175552514.png)
...
打包后，可以生成，浏览器能够直接运行的网页 => 就是需要上线的源码！![image-20240112175907311](./image/image-20240112175907311.png)
...
![image-20240112180311639](./image/image-20240112180311639.png)
...
![image.png](./image/01-1708571996927-144.png)
...
![image.png](./image/2-1708571996927-145.png)
...
![image.png](./image/3-1708571996927-146.png)

## 熟悉项目和关键文件

![image.png](./image/4-1708571996927-147.png)
...
![image.png](./image/5-1708571996927-148.png)
...
![image.png](./image/6-1708571996927-149.png)
...
![image.png](./image/7-1708571996927-150.png)
...
![image.png](./image/8-1708571996927-153.png)
...
![image.png](./image/9-1708571996927-152.png)
...
![image.png](./image/10-1708571996927-154.png)
...
![image.png](./image/11-1708571996927-151.png)
...
![image.png](./image/12-1708571996927-155.png)

### 3. 跨层传递响应式数据

> 在调用provide函数时，第二个参数设置为ref对象

![image.png](./image/13-1708571996927-156.png)

### 4. 跨层传递方法

> 顶层组件可以向底层组件传递方法，底层组件调用方法修改顶层组件的数据

![image.png](./image/14-1708571996927-157.png)
...
![image-20230704082955748](./image/image-20230704082955748-1708571996927-158.png)
...
![image-20230704083027349](./image/image-20230704083027349-1708571996927-159.png)

我们需要先定义 props，再定义 emits 。其中有许多重复的代码。如果需要修改此值，还需要手动调用 emit 函数。

于是乎 defineModel 诞生了。

![image-20230704083056549](./image/image-20230704083056549-1708571996927-160.png)
...
![image-20230711003405635](./image/image-20230711003405635-1705203743688-12.png)
...
![image-20230706205300370](./image/image-20230706205300370-1705203743689-13.png)

![image-20230706210947086](./image/image-20230706210947086-1705203743689-14.png)

![image-20230706211055251](./image/image-20230706211055251-1705203743689-15.png)

![image-20230706211033589](./image/image-20230706211033589-1705203743689-16.png)
...
![image-20230710172832242](./image/image-20230710172832242-1705203743689-17.png)
...
![image-20230710215822678](./image/image-20230710215822678-1705203743689-18.png)
...
![image-20230710225018162](./image/image-20230710225018162-1705203743689-19.png)
...
![image-20230711071913061](./image/image-20230711071913061-1705203743689-20.png)
...
![image-20230724224754131](./image/image-20230724224754131-1705203743689-21.png)
